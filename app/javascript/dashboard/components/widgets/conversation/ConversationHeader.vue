...
<template>
  <!-- OPENSF UI: reversible visual header treatment for active conversations. -->
  <div
    ref="conversationHeader"
    class="opensf-conversation-header flex flex-col gap-3 items-center justify-between flex-1 w-full min-w-0 xl:flex-row px-3 pt-3 pb-2 h-24 xl:h-12"
  >
    <div
